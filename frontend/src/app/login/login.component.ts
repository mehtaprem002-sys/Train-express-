        ...
        <div class="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
          ...
          <div class="text-center max-w-md animate-fade-in delay-200">
            ...
            <p class="text-lg text-cyan-50 font-medium leading-relaxed" style="text-shadow: 0 2px 4px rgba(0, 0, 0, 0.5), 0 0 20px rgba(6, 182, 212, 0.3);">
              Experience seamless train booking with premium features, real-time updates, and unmatched convenience.
            </p>
          </div>
          ...
          <div class="mt-12 flex gap-8 animate-fade-in delay-500">
            <div class="text-center">
              <div class="text-3xl font-black text-cyan-300 drop-shadow-lg">10K+</div>
              <div class="text-sm text-cyan-100" style="text-shadow: 0 1px 3px rgba(0, 0, 0, 0.5);">Happy Travelers</div>
            </div>
            <div class="h-12 w-px bg-cyan-400/30"></div>
            <div class="text-center">
              <div class="text-3xl font-black text-cyan-300 drop-shadow-lg">500+</div>
              <div class="text-sm text-cyan-100" style="text-shadow: 0 1px 3px rgba(0, 0, 0, 0.5);">Routes Available</div>
            </div>
            <div class="h-12 w-px bg-cyan-400/30"></div>
            <div class="text-center">
              <div class="text-3xl font-black text-cyan-300 drop-shadow-lg">24/7</div>
              <div class="text-sm text-cyan-100" style="text-shadow: 0 1px 3px rgba(0, 0, 0, 0.5);">Support</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div class="w-full max-w-md relative z-10">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 p-8 animate-fade-in-up">
            ...
            <!-- Form -->
            <form (ngSubmit)="onLogin()" class="space-y-5 animate-fade-in delay-200">
              <div>
              ...
              <div>
                <div class="flex justify-between items-center mb-2">
                  ...
                  <a routerLink="/forgot-password" class="text-xs font-semibold text-primary hover:text-primary-dark cursor-pointer">Forgot Password?</a>
                </div>
                <div class="relative">
              ...
              <div class="pt-2">
                <button type="submit" class="w-full bg-primary hover:bg-primary-dark text-white font-bold py-3.5 rounded-xl shadow-lg shadow-primary/30 transition-all active:scale-95 flex items-center justify-center gap-2 hover:-translate-y-0.5 transform duration-200">
                  <span>Sign In</span>
            ...
            <div class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
              Don't have an account? <a routerLink="/register" class="font-bold text-primary hover:underline cursor-pointer">Create Account</a>
            </div>
          </div>
        </div>
      </div>
